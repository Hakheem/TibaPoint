    ...
    switch (status) {
      case "PENDING":
        return {
          ...
          description:
            "We're currently reviewing your credentials and documents. This process usually takes 1-3 business days.",
      ...
      case "REJECTED":
        return {
          ...
          description:
            "Your verification request has been rejected. Please review the issues below and update your information.",
          color: "text-red-600",
          bgColor: "bg-red-50",
      ...
      <div className="max-w-7xl mx-auto px-4 pb-8 pt-16 md:pt-24 lg:pt-20">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card
              className={`${statusConfig.borderColor} border overflow-hidden`}
            >
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="col-span-2">
                    <div className="flex items-center space-x-4">
                      <div
                        className={`p-3 rounded-lg bg-white border ${statusConfig.borderColor}`}
                      >
                        <Icon className={`w-8 h-8 ${statusConfig.iconColor}`} />
                      </div>
                      <div>
                        <CardTitle
                          className={`text-2xl ${statusConfig.color} mb-1`}
                        >
                          {statusConfig.title}
                        </CardTitle>
                  ...
                  <div className="flex items-center justify-end">
                    <div
                      className={`px-4 py-2 rounded-full ${statusConfig.bgColor} border ${statusConfig.borderColor} whitespace-nowrap`}
                    >
                      <span
                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      {statusConfig.nextSteps.map((step, index) => (
                        ...
                        >
                          <div className="shrink-0 w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center mr-3">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    <div
                      className={`shrink-0 w-8 h-8 rounded-full ${statusConfig.bgColor} flex items-center justify-center mr-3`}
                    >
                  ...
                  <div className="flex items-start">
                    <div className="shrink-0 w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center mr-3">
