...
export async function generateMetadata() {
  ...
  return {
    ...
    description: `Doctor dashboard for ${user.name} specializing in ${
      user.speciality || "healthcare"
    }. Manage appointments, profile, and patient care.`,
    openGraph: {
      title: `${title} - TibaPoint`,
      description: `Doctor profile for ${user.name} specializing in ${
        user.speciality || "healthcare"
      }`,
      type: "profile",
    },
