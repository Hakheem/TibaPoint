  ...
  return (
    <section className="relative py-16 md:py-24">
      ...
      <div className="container padded mx-auto relative z-10">
        ...
        <div className="relative text-center mt-12 md:mt-16 p-8 rounded-2xl bg-linear-to-br from-blue-100 via-blue-50 to-transparent dark:from-primary/30 dark:via-primary/10 dark:to-transparent border border-primary/10 dark:border-teal-500/20 max-w-2xl mx-auto">
