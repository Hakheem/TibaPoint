  ...
  try {
    ...
    return {
      ...
      description:
        ...
        `Book online consultation with Dr. ${doctor.name}, ${doctor.speciality} specialist.`,
      openGraph: {
                ...
                <CardContent className="space-y-4">
                  ...
                  {canBook ? (
                    <Button size="lg" className="w-full" asChild>
                      <a href={`/book/${doctor.id}`}>Book Appointment</a>
                    </Button>
                  ) : currentUser ? (
                    <Button
                      size="lg"
        ...
        <Tabs defaultValue="reviews" className="space-y-8">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="reviews">
              Reviews ({doctor.reviewsReceived?.length || 0})
            </TabsTrigger>
              ...
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground max-w-md mx-auto">
                    Dr. {doctor.name} doesn&apos;t have any reviews yet. Be the
                ...
                <div>
                  ...
                  <ol className="space-y-3">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Receive confirmation and 2 credits will be deducted
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="h-6 w-6 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Receive prescription and notes after consultation
                      </span>
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-500" />
                      <span>
                        You need 2 credits for each 30-minute consultation
                      </span>
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-500" />
                      <span>
                        Cancel at least 2 hours before for partial refund
                      </span>
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-500" />
          ...
          <Card className="border-primary/20 bg-primary/5">
            <CardContent className="py-8">
              <h3 className="text-2xl font-bold mb-4">
                Ready to Consult with Dr. {doctor.name}?
              </h3>
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Book a 30-minute video consultation to discuss your health
                concerns and receive professional medical advice.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                {canBook ? (
                  ...
                  <Button size="lg" asChild>
                    <a href="/pricing">Purchase Credits to Book</a>
                  </Button>
                ) : (
                  <Button size="lg" asChild>
                    <a href="/sign-in?redirect_url=/book-appointment">
                ...
                <Button size="lg" variant="outline" asChild>
                  <a href="/doctors">Browse Other Doctors</a>
                </Button>
              </div>
            </CardContent>
          </Card>
