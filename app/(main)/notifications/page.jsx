...
export default function PatientNotificationsPage() {
  ...
  const getNotificationDescription = (type) => {
    const descriptions = {
      ...
      REMINDER: "Reminders for upcoming consultations",
      SYSTEM: "System updates and announcements",
      CREDIT_EXPIRY: "Credit balance and expiry alerts",
      REFUND: "Refund and payment notifications",
      PAYMENT: "Payment and billing updates",
      SECURITY: "Security and account alerts",
      SUPPORT: "Support ticket updates",
      UPDATE: "Platform updates and news"
    };
  ...
  return (
    <div className="space-y-6 container padded mx-auto py-20">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold">Notifications</h1>
          <p className="text-muted-foreground mt-2">
            Stay updated with your appointments, payments, and important updates
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage your notification preferences and get support
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Get help with notifications or other issues
                  </p>
                </div>
              </div>
            </div>
