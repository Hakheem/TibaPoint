...
const DoctorPage = async () => {
  ...
  // For verified doctors, show dashboard
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">KES 45,000</p>
            </div>
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-6">
          <p className="text-gray-500">Your recent appointments and activities will appear here.</p>
        </div>
      </div>
    </div>
  )
