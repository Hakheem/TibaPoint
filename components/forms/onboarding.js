    ...
    if (role === "PATIENT") {
      ...
      await db.notification.create({
        data: {
          ...
          message:
            "Your account is ready. Start browsing verified doctors and book your first consultation.",
          actionUrl: "/doctors",
        },
      });
    ...
    if (role === "DOCTOR") {
      ...
      await db.notification.create({
        data: {
          ...
          message:
            "Your doctor profile has been submitted. Our team will verify your credentials within 24-48 hours. You'll receive an email once approved.",
