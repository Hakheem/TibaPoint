...
const Bone = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M17 3a3 3 0 013 3 3 3 0 01-3 3h-1l-5 6h-1a3 3 0 01-3 3 3 3 0 01-3-3 3 3 0 013-3h1l5-6h1a3 3 0 013-3z"
    />
  </svg>
);
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Complete your professional profile. All information will be verified
          by our team
        </CardDescription>
      </CardHeader>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-xs text-blue-700 mt-1">
                  Your profile will be reviewed within 24-48 hours. You will
                  receive an email notification once verified. Until then, you
          ...
          <p className="text-xs text-center text-muted-foreground">
            Your profile will be reviewed within 24-48 hours. You will receive
