...
const Tooth = ({ className }) => (
  ...
  >
    <path
      ...
      strokeWidth="2"
      d="M12 2C10 2 8 3 8 5v7c0 1-1 2-1 4v4c0 1 1 2 2 2s2-1 2-2v-4c0-1 0-2 1-2s1 1 1 2v4c0 1 1 2 2 2s2-1 2-2v-4c0-2-1-3-1-4V5c0-2-2-3-4-3z"
    />
  </svg>
);
...
const Ear = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M12 2C8 2 5 5 5 9c0 3 1 5 2 7 1 2 2 4 2 6 0 1 1 2 2 2h2c1 0 2-1 2-2 0-2 1-4 2-6 1-2 2-4 2-7 0-4-3-7-7-7zm0 5c-1 0-2 1-2 2s1 2 2 2 2-1 2-2-1-2-2-2z"
    />
  </svg>
);
...
const Skull = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M12 2C7 2 3 6 3 11c0 4 2 7 5 8v3h8v-3c3-1 5-4 5-8 0-5-4-9-9-9zM9 11a1 1 0 110-2 1 1 0 010 2zm6 0a1 1 0 110-2 1 1 0 010 2z"
    />
  </svg>
);
...
const Kidney = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M12 3c-3 0-5 2-6 5-1 2-1 5 0 7 1 3 3 5 6 5 2 0 3-1 4-2 1 1 2 2 4 2 3 0 5-2 6-5 1-2 1-5 0-7-1-3-3-5-6-5-2 0-3 1-4 2-1-1-2-2-4-2z"
    />
  </svg>
);
...
const Lung = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M12 3v6m0 0c-2 0-3 1-4 3-1 2-2 4-2 6 0 2 1 3 2 3 2 0 3-2 4-4m0-8c2 0 3 1 4 3 1 2 2 4 2 6 0 2-1 3-2 3-2 0-3-2-4-4"
    />
  </svg>
);
...
const Stomach = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M8 6c-1 1-2 3-2 5 0 3 1 6 3 8 1 1 2 2 3 2s2-1 3-2c2-2 3-5 3-8 0-2-1-4-2-5-1-2-3-3-5-3s-4 1-5 3z"
    />
  </svg>
);
...
const Bone = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M17 3a3 3 0 013 3 a3 3 0 01-3 3h-1l-5 6h-1a3 3 0 01-3 3 a3 3 0 01-3-3 a3 3 0 013-3h1l5-6h1a3 3 0 013-3z"
    />
  </svg>
);
...
export default function ResubmissionForm({ currentUser, onBack }) {
    ...
    try {
      ...
      if (result.success) {
        toast.success("Verification resubmitted", {
          description:
            "Your updated credentials have been submitted for review. You will be notified once verified.",
          duration: 5000,
        });
  ...
  const selectedSpecialityData = SPECIALITIES.find(
    (s) => s.value === selectedSpeciality
  );
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-600">
              Please review and update any incorrect information. Upload new
              documents if needed.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            {selectedSpecialityData && (
              <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg mt-2">
                <div
                  className={`p-2 rounded-md ${selectedSpecialityData.color.replace(
                    "text-",
                    "bg-"
                  )}/10`}
                >
                  <selectedSpecialityData.icon
                    className={`h-5 w-5 ${selectedSpecialityData.color}`}
                  />
                </div>
                <div>
                  <p className="text-sm font-medium">
                    {selectedSpecialityData.value}
                  </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              <AlertCircle className="h-5 w-5 text-blue-600 mr-2 shrink-0 mt-0.5" />
              <div>
                <p className="text-sm text-blue-800 font-medium">
                  Resubmission Process
                </p>
                <p className="text-xs text-blue-700 mt-1">
                  Your updated information will be reviewed within 24-48 hours.
                  Your verification status will be reset to "Pending" until the
                  review is complete.
                </p>
              </div>
            </div>
          ...
          <p className="text-xs text-center text-muted-foreground">
            Your updated information will be reviewed within 24-48 hours. You
